/* シナリオ正本。台詞・分岐・エンディングは改変しない */
   const scenarios = {
       ...
       'final_choice': { 
           ...
           choices: [
               { text: "記憶を差し出す", nextScene: 'memory_end_check' },
               { text: "ふざけるなと拒絶する", nextScene: 'reject_check' }
           ]
       },

       'memory_end_check': {
           checkFlag: 'minaSaved',
           trueScene: 'end_remembered',
           falseScene: 'end_memory_loss'
       },
       'reject_check': {
           checkAll: ['greed', 'yandere'],
           trueScene: 'end_amusement',
           falseScene: 'battle_start'
       },
       ...
       'end_remembered': {
           ...
           texts: [
               ...
               { name: "魔王", content: "「契約だ」" },
               { name: "システム", content: "白い光が、名前も顔も、ぬくもりさえさらっていく。", effect: "white-out" },
               { name: "ミナ", content: "「大丈夫。忘れても、私が覚えてるから」" },
               { name: "息子", content: "「……ねえ、隣にいるの、だあれ？」" },
               { name: "ミナ", content: "「あなたのお母さんのことを、知ってる人だよ」" },
               { name: "システム", content: "〜 GOOD END : 誰かが覚えている 〜", textClass: "text-gold" }
           ],
           nextScene: null
       },
       'end_amusement': {
           ...
           texts: [
               ...
               { name: "ピエロ", content: "「ククク……ほらね。愛じゃなく、所有です」", textClass: "shaking-text" },
               { name: "システム", content: "赤い宝石が熱を持ち、魔王の薬とひとつになる。", effect: "noise-start" },
               { name: "主人公", content: "薬は手に入った。息子は助かる。けれど、離す気がしない。" },
               { name: "息子", content: "「……ママ、こわいよ」" },
               { name: "主人公", content: "「大丈夫。二度と、誰にも渡さないわ」" },
               { name: "ピエロ", content: "「最高の余興でしたよ、お母さん」" },
               { name: "システム", content: "〜 BAD END : 余興 〜", textClass: "text-blood" }
           ],
           nextScene: null
       },
       'end_bad_dead': {
